...
export class Client {
  ...
  private async registerComplete(credential: PublicKeyCredential, sessionId: string, credentialNickname: string): Promise<RegisterCompleteResponse> {
  ...
  private async signinComplete(credential: PublicKeyCredential, sessionId: string): Promise<SigninCompleteResponse> {
